...
class RunAction : public G4UserRunAction
{
  ...
  public:
    ...
    void AddNbElectronsStrip1(G4int i)  {fNbElectronsStrip1[i] ++;};
    void AddNbElectronsStrip2(G4int i)  {fNbElectronsStrip2[i] ++;};
  ...
  private:
    ...
    G4int fNbElectronsStrip1[1017];
    G4int fNbElectronsStrip2[1017];
